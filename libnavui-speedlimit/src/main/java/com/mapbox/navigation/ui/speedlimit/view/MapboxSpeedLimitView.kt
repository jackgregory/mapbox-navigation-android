...
class MapboxSpeedLimitView : FrameLayout, MapboxView<SpeedLimitState> {
    ...
    private var mapboxSpeedLimitBackground: ImageView? = null
    private var mapboxSpeedLimitText: TextView? = null
    ...
    init {
        LayoutInflater.from(context).inflate(R.layout.mapbox_speedlimit_layout, this, true)
        mapboxSpeedLimitBackground = findViewById(R.id.mapboxSpeedLimitBackground)
        mapboxSpeedLimitText = findViewById(R.id.mapboxSpeedLimitText)
    }
    ...
    private fun initAttributes(attrs: AttributeSet?) {
        ...
        ContextCompat.getColor(
            ...
            mapboxSpeedLimitText?.setTextColor(it)
        }
    ...
    private fun renderState(state: SpeedLimitState.UpdateSpeedLimit) {
        ThreadController.getMainScopeAndRootJob().scope.launch {
            ...
            mapboxSpeedLimitBackground?.setImageDrawable(layerDrawable)
            mapboxSpeedLimitText?.setText(speedLimitSpan, TextView.BufferType.SPANNABLE)
        }
    }
    ...
    private fun getSpeedLimitSpannable(state: SpeedLimitState.UpdateSpeedLimit): SpannableStringBuilder {
    ...
    internal fun getFinalDrawable(signFormat: SpeedLimitSign): LayerDrawable {
        ...
        val borderDrawable = borderDrawable(drawableShape, speedLimitMutcdBorderColor, speedLimitViennaBorderColor)
